...
<head>
  ...
  <link rel="icon" type="image/png" href="Bakisenalogo.png">
</head>
...
<body>
  ...
  <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/ContactUs.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="col-md-8">
          <div class="row mb-5">
            <div class="col-md-4 text-center py-4">
              ...
              <p><span>Address:</span>6PM4+7C, Cairo Governorate Desert, Al-Sharqia Governorate 7060010</p>
            </div>
            <div class="col-md-4 text-center border-height py-4">
              <div class="icon">
                <span class="icon-mobile-phone"></span>
              </div>
              <p><span>Phone:</span> <a href="tel://1234567920">+2 010 70919637</a></p>
            </div>
            <div class="col-md-4 text-center py-4">
              <div class="icon">
                <span class="icon-envelope-o"></span>
              </div>
              <p><span>Email:</span> <a href="mailto:info@yoursite.com">hesham.sakr@sut.edu.eg</a></p>
            </div>
          </div>
        </div>
      </div>

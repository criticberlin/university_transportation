...
<html lang="en">
<head>
    <title>SUTSwift - Manage Buses</title>
    <meta charset="utf-8">
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
            <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
                <div class="text">
                    ...
                    <p style="font-size: 18px;">Easily manage all transportation Buses for the university system</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="text-center mt-4">
                    <a class="btn btn-custom mr-2" href="add_bus.php">Add New Bus</a>
                </div>
            </div>
        </div>
    </div>

        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
            <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
                <div class="text">
                    ...
                    <p style="font-size: 18px;">Easily manage all transportation routes for the university system</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <?php foreach ($routes as $route): ?>
                                <tr data-routeid="<?php echo $route['RouteID']; ?>">
                                    ...
                                    <td contenteditable="false" class="user-email">
                                        <?php echo htmlspecialchars($route['EndPoint']); ?>
                                    </td>
                                    <td contenteditable="false" class="user-phone">
                                        <?php echo htmlspecialchars($route['DistanceKM']); ?>
                                    </td>
                                    <td>
                                        <a href="delete_route.php?id=<?php echo $route['RouteID']; ?>" 

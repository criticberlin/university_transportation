<?php
session_start();
require_once 'config/database.php';  // Add database configuration
...
<html lang="en">
<head>
    <title>SUTSwift - Smart Parking</title>
    <meta charset="utf-8">
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
            <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
                <div class="text">
                    ...
                    <p style="font-size: 18px;">Welcome to our smart parking system. Find and reserve your parking spot easily.</p>
                </div>
            </div>
                ...
                <div class="request-form ftco-animate">
                    ...
                    <div class="dashboard-buttons">
                        <ul class="list-unstyled">
                            <li class="mb-3">
                                <a href="find_spot.php" class="btn btn-primary btn-lg btn-block d-flex align-items-center justify-content-between">
                                    <span><i class="icon-map-o mr-2"></i>Find Parking Spot</span>
                                    <i class="icon-arrow-right"></i>
                                </a>
                            </li>
                            <li class="mb-3">
                                <a href="my_reservations.php" class="btn btn-info btn-lg btn-block d-flex align-items-center justify-content-between">
                                    <span><i class="icon-calendar mr-2"></i>My Reservations</span>
                                    <i class="icon-arrow-right"></i>
                                </a>
                            </li>
                        </ul>
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>Smart parking solution for Suez University of Technology.</p>

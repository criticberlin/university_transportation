        ...
        <div class="container">
            <div class="row no-gutters slider-text justify-content-start align-items-center">
                <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
                    <div class="text">
                        <h1 class="mb-4">Hello, <?php echo htmlspecialchars($_SESSION['FullName']); ?>!</h1>
                        <p style="font-size: 18px;">Welcome to Bakisena. Find and reserve your parking spot easily.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>
                        ...
                        </script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="index.php" target="_blank">Colorlib</a>
                    </p>
                </div>
            </div>
        </div>

...
<html lang="en">
<head>
    <title>SUTSwift - Student Dashboard</title>
    <meta charset="utf-8">
        ...
        <div class="request-form ftco-animate">
            ...
            <div class="dashboard-buttons">
                <ul class="list-unstyled">
                    <li class="mb-3">
                        <a href="view_trips.php" class="btn btn-primary btn-lg btn-block d-flex align-items-center justify-content-between">
                            <span><i class="icon-map-o mr-2"></i>View Available Trips</span>
                            <i class="icon-arrow-right"></i>
                        </a>
                    </li>
                    <li class="mb-3">
                        <a href="my_reservation.php" class="btn btn-success btn-lg btn-block d-flex align-items-center justify-content-between">
                            <span><i class="icon-calendar mr-2"></i>My Reservations</span>
                            <i class="icon-arrow-right"></i>
                        </a>
                    </li>
                    <li class="mb-3">
                        <a href="contact_driver.php" class="btn btn-info btn-lg btn-block d-flex align-items-center justify-content-between">
                            <span><i class="icon-phone mr-2"></i>Contact Driver</span>
                            <i class="icon-arrow-right"></i>
                        </a>
                    </li>
                </ul>
